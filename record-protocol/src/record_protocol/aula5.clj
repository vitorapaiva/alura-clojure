...
(let [particular {:id 15 :nome "guilherme" :nascimento "11/11/1111" :situacao :normal}
      plano {:id 15 :nome "guilherme" :nascimento "11/11/1111" :situacao :normal :plano [:raio-x :ultrassom]}]
  (pprint (deve-assinar-pre-autorizacao? {:paciente particular :valor 1000 :procedimento :coleta-de-sangue}))
  (pprint (deve-assinar-pre-autorizacao? {:paciente plano :valor 100 :procedimento :coleta-de-sangue}))
  )
